...
CHART_CONFIGS: Final[tuple[ChartConfig, ...]] = (
    ...
    ChartConfig(
        ...
        metric_series=(
            ...
            ChartSeriesConfig(metric_key="coins_from_critical_coin"),
            ChartSeriesConfig(metric_key="coins_from_golden_combo"),
            ChartSeriesConfig(metric_key="guardian_coins_stolen"),
            ChartSeriesConfig(metric_key="guardian_coins_fetched"),
            ChartSeriesConfig(metric_key="golden_bot_coins_earned"),
        ),
        filters=ChartFilters(
            date_range=DateRangeFilterConfig(enabled=True, default_start=DEFAULT_START),
            tier=SimpleFilterConfig(enabled=True),
    ...
    ChartConfig(
        id="gems_earned",
        title="Gems Earned",
        description="Observed gems earned per run from newer Battle Reports.",
        category="economy",
        domain="economy",
        semantic_type="absolute",
        chart_type="line",
        metric_series=(ChartSeriesConfig(metric_key="gems_earned"),),
        filters=ChartFilters(
            date_range=DateRangeFilterConfig(enabled=True, default_start=DEFAULT_START),
            tier=SimpleFilterConfig(enabled=True),
            preset=SimpleFilterConfig(enabled=True),
    ...
    ChartConfig(
        id="ad_gems_earned",
        title="Ad Gems Earned",
        description="Observed ad gems earned per run from newer Battle Reports.",
        category="economy",
        domain="economy",
        semantic_type="absolute",
        chart_type="line",
        metric_series=(ChartSeriesConfig(metric_key="ad_gems_earned"),),
        filters=ChartFilters(
            date_range=DateRangeFilterConfig(enabled=True, default_start=DEFAULT_START),
            tier=SimpleFilterConfig(enabled=True),
            preset=SimpleFilterConfig(enabled=True),
    ...
    ChartConfig(
        id="medals_earned",
        title="Medals Earned",
        description="Observed medals earned per run from newer Battle Reports.",
        category="economy",
        domain="economy",
        semantic_type="absolute",
        chart_type="line",
        metric_series=(ChartSeriesConfig(metric_key="medals_earned"),),
        filters=ChartFilters(
            date_range=DateRangeFilterConfig(enabled=True, default_start=DEFAULT_START),
            tier=SimpleFilterConfig(enabled=True),
            preset=SimpleFilterConfig(enabled=True),
    ...
    ChartConfig(
        ...
        ui=ChartUI(show_by_default=False, selectable=True, order=18),
    ),
    ChartConfig(
        ...
        ui=ChartUI(show_by_default=False, selectable=True, order=19),
    ),
    ChartConfig(
    ...
    ChartConfig(
        id="damage_percent_by_source_stacked",
        title="% Damage by Source (Per Run)",
        description="Percent contribution of each damage source per run (100% stacked).",
        category="damage",
        domain="damage",
        semantic_type="contribution",
        chart_type="bar",
    ...
    ChartConfig(
        id="damage_vs_enemies_destroyed_bar",
        title="Damage vs Enemies Destroyed (Bar)",
        description="Side-by-side bars per run for damage dealt and enemies destroyed.",
        category="damage",
        domain="damage",
        semantic_type="comparative",
        chart_type="bar",
