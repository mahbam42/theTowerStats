...
**** TODO [#A] Merge PR Branches from Dependabot
...
**** TODO [#A] Add Card Usage Table in a Modal
...
**** TODO [#B] Security Warning: Pygments has Regular Expression Denial of Service (ReDoS) due to Inefficient Regex for GUID Matching
...
**** TODO [#B] Security Warning: Incomplete URL substring sanitization
Sanitizing untrusted URLs is a common technique for preventing attacks such as request forgeries and malicious redirections. Usually, this is done by checking that the host of a URL is in a set of allowed hosts.
...
**** TODO [#B] Bot Respec needs to Lock All Bots, reset levels and goals (for bots) :bug:fix:

**** TODO [#C] Collapse Query Templates on Explore Dashboard         :fix:
When query is run

*** Future
**** WAIT Game v28.0 Changes
