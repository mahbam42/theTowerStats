...
**** TODO [#A] Hide Admin Link if logged in as non admin/superuser
**** TODO [#B] On UW/Bots/Guardian Chip Dashboards add a Decrease Level Button
Safe guard in case a user accidently clicks upgrade by mistake
**** TODO [#B] Move UW Sync Graph to Bottom of Dashboard 
