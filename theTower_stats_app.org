...
**** TODO [#A] Game Patch v27.4.0 [0/6]
***** TODO [#A] In Explore Dashboard Table 'Runs Counted' column needs to only show once with multiple metrics. :bug:
It makes the tables harder to read. 
***** TODO [#A] Add 3rd Gaurdian Chip Slot                  :enhancement:
Allow up to 3 Guardian Chips to be equiped.
Add unlock for the slots, 2nd slot is 200 bits, 3rd is 300 bits.
***** TODO [#B] On the Cards Dashboard, the Cards Table default sort needs to be by Rarity. :bug:
***** TODO [#B] Add Patch Boundary Support to Eplore DSL and Charts. :enhancement:
Add as a filter.
***** TODO [#A] Improve Metrics Documentation                       :bug:
