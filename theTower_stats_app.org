...
**** IN PROGRESS [#B] On Battle History clicking on a Battle Report Row opens a modal of the raw input
...
**** TODO On Charts Dashboard Datapoint "Run:" needs to be clickable and open the Battle Report Modal
** Backlog [2/6]
“Out of Scope”:
- Cloud sync
- Real-time scraping
