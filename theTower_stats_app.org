...
- [X] Changelog Updates everything since 2cb639c
  git log -15 --oneline
**** TODO [#C] add a small “Total” badge in the chart header to make the behavior more discoverable.
Enhancement to Free Upgrades Chart 
**** TODO [#A] Free Upgrades vs Coins Earned (scatter)
...
**** TODO [#A] On Battle History show Run Number
...
**** TODO [#B] Custom Column Display on Battle History Dashboard
...
**** TODO [#C] On Charts dashboard add a note that players can ctrl(/cmd) click multiple charts
