...
**** TODO [#A] Add an “Explore Battles” surface (separate dashboard) :feat:
...
**** TODO [#A] Enforce Level 0 Bot Parameter Levels                  :bug:
...
**** TODO [#B] Add 'Recovery Packages' to Battle Dashboard         :patch:
Hidden by Default, can be shown via Columns Menu

**** TODO [#B] On charts dashboard add control to context to exclude multiple presets
...
**** TODO [#C] Add note to user docs that 'imported' Battle Logs are timestamped in UTC :bug:

**** TODO [#C] Hide Deathwave and/or Golden Bot on UW Sync Chart   :patch:
...
**** TODO [#A] Update Readme and Changelog
