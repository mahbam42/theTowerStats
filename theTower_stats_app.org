...
**** TODO [#A] First-run onboarding                                   :UX:

One-page “What this app does / doesn’t do”

A single sample chart + explanation

**** TODO [#B] Revise Dashboard Docs to be Per Feature                :UX:
...
**** TODO [#C] Error Recovery UX                          :UX:enhancement:
