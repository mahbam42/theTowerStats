...
**** TODO [#A] New Battle Report Metrics
...
**** TODO [#A] Verify parser can handle the new Battle Report format

**** TODO [#A] Charts are ignoring Blackhole Damage                  :bug:
...
**** TODO [#A] Upgrade django version to 5.2.13
Will resolve some security warnings from Dependabot
**** TODO [#C] Pull and merge Dependabot version bumps
