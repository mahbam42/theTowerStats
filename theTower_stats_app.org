...
**** TODO Move Metrics Reference off of Chart Builder and into Reference Section. :docs:
...
**** TODO [#A] On the Free Upgrades by Run Chart the Total needs to show the combined total of all three metrics :bug:
See screenshot
**** TODO Fix text in Goals Modal                                    :bug:
See screenshot
**** TODO Fix Preset Label in 'Add Battle Report'                    :bug:
