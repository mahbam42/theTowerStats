...
2. Improve Visual Hierarchy (Low Effort, High Impact)
...
3. Navigation Bar Cleanup (Important)
...
4. Global Theming & Styling Suggestions
...
5. Advice Section: Make It Feel Smarter (Even Before It Is)

Even if the logic stays the same:

  * Frame advice as **observations**, not blocks of text
  * Use bullet summaries with expandable detail
  * Tie advice visually to the charts it references

This reinforces trust and reduces the “wall of explanation” feel.

6. A Simple North Star (Use This to Decide Cuts)

  > **Primary loop:**
  > “What changed → Why → Compared to what → What does that mean”

  Every control, section, and visual should clearly support one of those steps.
  If it doesn’t, hide it, collapse it, or move it out of the default view.

**** TODO [#A] Make Charts Dashboard more Mobile Friendly
...
**** TODO [#A] Implement Search
Search should have global scope within the app. 

**** TODO [#B] Implement ChangeLog.md
