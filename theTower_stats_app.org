...
**** TODO [#A] Pillar 1: Multiple Player Support (Foundational, Blocking)
...
**** TODO [#A] Precondition: Advice Language Enforcement Pass
...
**** TODO [#A] Pillar 2: Advice Becomes Safe, Scoped, and Goal-Aware
...
**** TODO [#A] Pillar 3: Demo, Export, and Adoption Features (Non-Blocking)
