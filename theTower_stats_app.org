...
**** TODO [#B] Add a 'Killed By' Donut Chart 
...
**** TODO [#A] Scope and Apply Permissions (Blocking)
...
**** TODO [#A] On the UW Dashboard Runs Used is not updating appropriately  (Blocking)
...
**** TODO [#C] User Guide Operation                                 :docs:
...
- Cloud sync
- Real-time scraping
*** TODO [#A] Review Docs and Note Revisions                          :Max:
