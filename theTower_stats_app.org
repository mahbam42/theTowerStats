...
**** TODO [#B] Explore Dashboard should compare based on Runs in Set and not skip missing tiers. :bug:
If there are no tier 3 runs, tier 4 should compare with 2, for example. 
**** TODO [#B] Saved Queries need to store comments               :ux:bug:
...
**** TODO [#C] On Charts Dashboard, Compare and Advice should open in a modal and not on the dashboard. :feat:
...
**** TODO Update Changelog, readme, etc
