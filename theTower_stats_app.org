...
**** TODO [#C] Improve Coverage for core/charting/builder.py: 40%    :ops:

**** TODO [#B] Change Theme to Dark Mode                              :UX:

**** TODO [#A] Make All Dashboards more Mobile Friendly               :UX:
...
**** TODO [#A] Charts Dashboard Improvements [0/5]
***** TODO [#A] Change Default Granularity to 'by battle log'        :UX:

***** TODO [#B] Move 'Include Tournaments' up next to date range buttons

***** TODO [#B] Rearrange Controls Under More Options [0/2]
...
***** TODO [#B] Break up Charts Documentation
...
***** TODO On the Chart Builder Doc add a table listing  all the metrics
Note the source and how it's calculated 

**** IN PROGRESS Codex Prompt40.md
...
- [ ] 5. Builder coverage improvements
- [ ] fix test failure: FAILED tests/test_phase8_pillar3_demo_export.py::test_export_derived_metrics_csv_returns_csv_snapshot - AssertionError: assert {'2025-12-10 ...3:45 • Run 2'} == {'2025-12-10', '2025-12-11'}
  1 failed, 271 passed in 34.57s
- [ ] 6. On Charts Dashboard in Compare, the Scope A and B selects need to show the Tier, Wave, and Date. The 'Battle Report' field is more internal and not helpful to front end players.
- [ ] Revise: Default Granularity
- [ ] Update Changelog to reflect recent commits/Enhancements.
