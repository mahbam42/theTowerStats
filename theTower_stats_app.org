...
**** TODO Revise Dashboard Docs to be Per Feature
...
**** TODO [#B] If Battle Date isn't present in Battle Report fail over to parsed time :bug:
...
**** TODO [#C] Improve Coverage for core/charting/builder.py: 40%
