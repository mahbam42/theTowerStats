...
**** TODO [#A] Add missing bot metrics                               :bug:
...
**** TODO [#B] Add Bot Respec Button to Bots Dashboard              :feat:
...
**** TODO [#C] On Battle History add toggle to mark as hidden. Hidden reports will not be included in Charts and Explore Results unless toggled. Lifetime Stats will always include all stored reports. :feat:

***** TODO On Charts and Explore add control to include hidden Battle Reports 

**** IN PROGRESS [#A] Verify wiki fetch support for Scout Guardian Chip (Blocking)
