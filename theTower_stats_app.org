...
**** TODO [#B] Lifetime Stats Modal                                 :feat:
...
**** TODO [#B] Calculator Tools Dashboard                           :feat:
...
**** TODO [#B] Reddit Request Cells and Reroll Shards per Hour Metrics :feat:
...
**** TODO [#B] Cells Earned not showing for values over 1000 on Battle History :bug:
Cells Earned	1.09K
Shows as "-" on Dashboard
**** TODO [#C] metric guardian_damage and guardian_enemies_summoned need to allow average and sum :bug:
