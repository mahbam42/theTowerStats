...
**** TODO Make Getting Started the default homepage 
...
- [ ] Remove 'total' line from 'Free Upgrades by Run' stacked chart. We need to show the total (sum of Attack, Defense, and Utility) somewhere on the Chart. 
- [ ] Changelog Updates everything since 2cb639c
  git log -15 --oneline
