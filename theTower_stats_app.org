...
**** TODO [#A] Can we set up GitHub Actions to use Postgres so CI is testing closer to Production? :chore:

**** TODO [#B] Standardized/Enforce Unit Display                     :bug:
In Modals Especially
And Compare/Advice Results

**** TODO [#B] Player Preferences                            :enhancement:
