...
**** TODO [#B] In the UW Sync Graph exclude Death Wave from Cumulative Overlap calculation

Since we don't have a duration for Death Wave, the overlap shows a very small percentage. 

**** TODO [#C] In the UW Sync Graph don't show the UWs/Bots at 0
