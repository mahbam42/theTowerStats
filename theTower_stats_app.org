...
- List all Cards in a Collapsible Table
  ...
  - Filter by Preset
***** TODO [#A] Inventory needs to track progress toward next level
...
***** TODO [#A] Parameter Column should be populated with card_definition.description
***** TODO [#A] Need a Filter Reset button for Presets
There should be an easier way that editing the Query String in the URL 
***** TODO [#B] Preset Membership should be styled as badges
...
***** TODO [#C] Preset Tags Widget labels should be styled to match and be clickable links to apply the filter

***** WAIT [#C] Remove Card Library Block
- State "WAIT"       from "TODO"       [2025-12-16 Tue 17:38] \\
  haven't decided yet
It's big and not necessary. 

***** TODO [#B] Battle History <-> Preset Linking
**** TODO UW Progress
