...
**** IN PROGRESS [#B] Dark Mode Cleanup                              :bug:
...
**** TODO [#C] Standardized/Enforce Unit Display                     :bug:
In Modals Especially
And Compare/Advice Results

**** TODO [#C] Player Preferences                            :enhancement:
Store Favorite Charts for Charts Dashboard
Store Chart Builder creations 

**** TODO [#B] MOTD with latest changelog entry              :enhancement:
Add to getting_started as well (between quick start and self host)

**** TODO [#C] Compare Scopes needs to include Tournaments           :bug:
In the Run Select List, Tournaments should be available. 

**** TODO [#C] On Charts Dashboard in Context Tier Select needs to include tournaments :bug:
Replace with a dropdown list of recorded tiers and 'tournament's 

**** TODO [#B] Add Ability to Filter  by Snapshot or View Past N Runs on Chart Dashboard :enhancement:
In the Context panel in addition to the date, tier and preset selects. 

**** TODO [#A] Improve Snapshots Implementation              :enhancement:
...
**** TODO [#A] Add Tournament Rank to Battle Report Import
...
Update Changelog and Readme to 0.7.1, MOTD should include 0.6.2 as well.
