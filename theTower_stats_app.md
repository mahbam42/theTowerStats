...
1.  [Stats Tracking App for The Tower Mobile Game](#org85c1282)
    1.  [Goals/Intent](#org3338919)
    2.  [Requirements](#orgd6c6526)
    3.  [Overall Architecture](#orgd150174)
    4.  [Features](#org33edb03)
    5.  [Core Responsibilities](#org2fdbba6)
        1.  [Rate Calculations](#orgf2fbcac)
        2.  [Delta Calculations](#orgb79f6c3)
        3.  [Parameterized Effects](#org158dece)
        4.  [Aggregations by Intent (Presets)](#org41f1215)
        5.  [Analysis Engine Invocation](#orged1705e)
        6.  [Output Shape](#org28715a2)
        7.  [Module Structure (Suggested)](#org41cad58)
    6.  [UX Design](#orgee134f9)
    7.  [Example Stat Data](#org9207e31)
    8.  [Models](#org01a3113)
        1.  [Game Data](#orgeeb4881)
        2.  [BotsParameters](#org781fe49)
        3.  [CardDefinition](#org6c739a2)
        4.  [CardLevel / Star](#org5a18d06)
        5.  [CardParameters](#org0b908cb)
        6.  [CardSlots](#orgcb39368)
        7.  [GuardianChipParemeters](#orgffe571e)
        8.  [PlayerBot](#orgd374c94)
        9.  [PlayerCard](#org56271e3)
        10. [PlayerGuardianChip](#org65a0deb)
        11. [PlayerUltimateWeapon](#orgc4576e6)
        12. [PresetTags](#orga0e7cd5)
        13. [UltimateWeaponParameters](#org9ff36b8)
        14. [Unit Model](#org4c91980)
        15. [WikiData](#orgd81b6bf)
    9.  [Views](#org90ddf3e)
        1.  [Battle History](#org8cb1f9f)
        2.  [Cards](#org36ea897)
        3.  [Charts](#org8a5a2e5)
        4.  [UW Progress](#orgbc602ac)
        5.  [Guardian Progress](#orgbe80499)
        6.  [Bots Progress](#org6ec0fc5)
    10. [Management Commands](#org4988aea)
        1.  [fetch<sub>wiki</sub><sub>data</sub>](#org565352a)
        2.  [add<sub>battle</sub><sub>report</sub>](#orgc92fd61)
    11. [Repo Structure](#org0f07033)
    12. [Testing Standards](#org00ab6f5)
    13. [Sprint Roadmap](#org842021a)
        1.  [Phase 1 Foundations](#org939c6f6)
        2.  [Phase 2 Context](#orge0191bb)
        3.  [Phase 3 — App Structure & UX](#org09812bd)
        4.  [Phase 4 Effects](#orga0057e6)
        5.  [Phase 5 Dashboard UX <code>[100%]</code>](#org4f2fd24)
        6.  [Phase 6 Expansion of Foundation and Context <code>[100%]</code>](#orgdcbec32)
        7.  [Phase 7 Power Tools <code>[100%]</code>](#orgc6a1e8e)
        8.  [Phase 8 Multiple Player Support <code>[100%]</code>](#org6be8a3c)
        9.  [Phase 9 Deploy and Clean out Backlog <code>[100%]</code>](#org944c0e2)
        10. [Phase 10 v0.2.0](#orgb703e87)
        11. [Phase 10B Additional UX](#org5e84220)
        12. [Phase 11 Bug Fixes <code>[6/6]</code>](#org971277b)
        13. [Bugs/Enhancements <code>[103/103]</code>](#orgb1dc088)
        14. [v0.10.0 <code>[15/15]</code>](#org2f94a9d)
        15. [v0.11.0 <code>[5/5]</code>](#orgffc2e7a)
        16. [v0.12.0 <code>[6/6]</code>](#org315d6f4)
        17. [Game v28.0 Changes <code>[5/5]</code>](#org2bffe34)
        18. [Add a way to tag runs as dissonance](#orgb5501b8)
        19. [Future](#org10abdda)
    14. [Backlog <code>[3/6]</code>](#orgeaebe5e)
        1.  [Labs Tracking](#orga6d0d24)
        2.  [Add Card Slots to Goals](#org086e517):patch:
        3.  [Exploratory Pattern Analysis (v0.X.0)](#org81e6932):kMeans:enhancement:
        4.  [Draft a “This app is done” release note](#orga8b6aa1)
        5.  [Required Doc Type Header (Must Prepend to All Docs)](#orge17e187)
        6.  [What-If Scenarios](#org69db1af)
        7.  [Ranked Recommendations](#org1cc49f0)
        8.  [Complete](#orgcd17921)
    15. [Codex Tasks](#orgf2fb8b3)
...
### DONE v0.10.0 <code>[15/15]</code>

-   State "DONE"       from              <span class="timestamp-wrapper"><span class="timestamp">[2026-03-27 Fri 15:27]</span></span>
...
11. DONE Dependabot Bug Fixes

    -   State "DONE"       from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-02-09 Mon 22:53]</span></span>
    -   We need a pipfile.lock drafted based on requirements.txt and requirements-dev.txt and possibly a dependabot.yml file
    -   Here is a list of the detected errors:
        -   Django has Observable Timing Discrepancy (found in requirements.txt)
            An issue was discovered in 6.0 before 6.0.2, 5.2 before 5.2.11, and 4.2 before 4.2.28. The django.contrib.auth.handlers.modwsgi.check<sub>password</sub>() function for authentication via mod<sub>wsgi</sub> allows remote attackers to enumerate users via a timing attack. Earlier, unsupported Django series (such as 5.0.x, 4.1.x, and 3.2.x) were not evaluated and may also be affected.
        ...
        -   Django has Inefficient Algorithmic Complexity
            An issue was discovered in 6.0 before 6.0.2, 5.2 before 5.2.11, and 4.2 before 4.2.28. django.utils.text.Truncator.chars() and Truncator.words() methods (with html=True) and the truncatechars<sub>html</sub> and truncatewords<sub>html</sub> template filters allow a remote attacker to cause a potential denial-of-service via crafted inputs containing a large number of unmatched HTML end tags. Earlier, unsupported Django series (such as 5.0.x, 4.1.x, and 3.2.x) were not evaluated and may also be affected.
        -   Django has an SQL Injection issue
            An issue was discovered in 6.0 before 6.0.2, 5.2 before 5.2.11, and 4.2 before 4.2.28. FilteredRelation is subject to SQL injection in column aliases via control characters, using a suitably crafted dictionary, with dictionary expansion, as the \*\*kwargs passed to QuerySet methods annotate(), aggregate(), extra(), values(), values<sub>list</sub>(), and alias(). Earlier, unsupported Django series (such as 5.0.x, 4.1.x, and 3.2.x) were not evaluated and may also be affected.
        -   Django has an SQL Injection issue
            An issue was discovered in 6.0 before 6.0.2, 5.2 before 5.2.11, and 4.2 before 4.2.28. .QuerySet.order<sub>by</sub>() is subject to SQL injection in column aliases containing periods when the same alias is, using a suitably crafted dictionary, with dictionary expansion, used in FilteredRelation. Earlier, unsupported Django series (such as 5.0.x, 4.1.x, and 3.2.x) were not evaluated and may also be affected.
        -   Django has an SQL Injection issue
            An issue was discovered in 6.0 before 6.0.2, 5.2 before 5.2.11, and 4.2 before 4.2.28. Raster lookups on RasterField (only implemented on PostGIS) allows remote attackers to inject SQL via the band index parameter. Earlier, unsupported Django series (such as 5.0.x, 4.1.x, and 3.2.x) were not evaluated and may also be affected.
    -   They all seem to point to the Django version we happened to be using as the problem. So I've already edited requirements.txt to enforce their recommended version 5.2.11

12. DONE Add missing bot metrics     :bug:

    -   State "DONE"       from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-02-14 Sat 12:56]</span></span>
    
    These are in each battle report, I'm not sure how they were missed. These metrics need to be added to battle report derived metrics and added to Chart Metrics and Explore DSL. 
    
    -   Flame Bot Damage
    -   Thunder Bot Stuns
    -   Golden Bot Coins Earned

13. DONE Add Bot Respec Button to Bots Dashboard     :feat:

    -   State "DONE"       from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-02-14 Sat 12:56]</span></span>
    
    Bots and their spent medals can be refunded through a bot respec. Bot respec is available for 300 Gems once per event. Labs completed for bots are not refunded through a bot respec, only medal related upgrades/unlocks.

14. DONE On Battle History add toggle to mark as hidden. Hidden reports will not be included in Charts and Explore Results unless toggled. Lifetime Stats will always include all stored reports.     :feat:

    -   State "DONE"       from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-02-14 Sat 12:47]</span></span>
    
    1.  TODO On Charts and Explore add control to include hidden Battle Reports

15. DONE Verify wiki fetch support for Scout Guardian Chip (Blocking)

    -   State "DONE"       from "IN PROGRESS" <span class="timestamp-wrapper"><span class="timestamp">[2026-02-14 Sat 12:56]</span></span>
    -   State "IN PROGRESS" from "WAIT"       <span class="timestamp-wrapper"><span class="timestamp">[2026-02-14 Sat 00:47] </span></span>   
        Wiki is updated, need to test the data on Dev first.
...
16. 0.10.2 <code>[0/1]</code>

    1.  TODO Incomplete URL Substring Sanitization     :bug:
    
        Copilot logged a high alert in core/management/commands/fetch<sub>wiki</sub><sub>data.py</sub>:685,
...
### DONE v0.11.0 <code>[5/5]</code>

-   State "DONE"       from              <span class="timestamp-wrapper"><span class="timestamp">[2026-03-27 Fri 15:27]</span></span>

1.  DONE Dependancy Cleanup

    -   State "DONE"       from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-03-17 Tue 17:21]</span></span>
    
    1.  TODO Bump django to 5.2.12 to resolve security issues     :chore:
    
        Found by Dependabot
        
        -   URLField.to<sub>python</sub>() in Django calls urllib.parse.urlsplit(), which performs NFKC normalization on Windows that is disproportionately slow for certain Unicode characters, allowing a remote attacker to cause denial of service via large URL inputs containing these characters.
    ...
    2.  TODO Merge dependabot PRs/Branches
    
        Mostly minor version bumps on dependencies.
        
        -   We'll accept mkdocs-material entering maintenance mode for now and evaluate alternatives in the future.
        -   The rest look minor for implementing
    
    3.  TODO Refactor to remove dj-database-url     :chore:
    
        It was a bootstrap solution to migration to railway when we first deployed. Things have been working smoother since so we need to remove the dependancy.

2.  DONE On Battle History Add Rank Filter to 'Top 3 Tournament Logs'     :enhancement:

    -   State "DONE"       from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-03-17 Tue 17:21]</span></span>
    
    Select Copper, Silver, Gold, Platinum, Champions, Legends to show top 3 for only the selected rank 

3.  DONE Respec Bots button disabled     :feat:

    -   State "DONE"       from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-03-17 Tue 17:22]</span></span>
    
    Should be initially accessible, then locked until the end of the current event window.

4.  DONE Add guardian<sub>coins</sub><sub>stolen</sub> to coins earned by source     :bug:

    -   State "DONE"       from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-03-17 Tue 17:21]</span></span>
    
    Don't know why it was missing but is needed. 

5.  DONE Query Templates
...
### DONE v0.12.0 <code>[6/6]</code>

-   State "DONE"       from              <span class="timestamp-wrapper"><span class="timestamp">[2026-03-27 Fri 15:27]</span></span>

1.  DONE Merge PR Branches from Dependabot

    -   State "DONE"       from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-03-27 Fri 15:27]</span></span>
    
    Bump mkdocs-get-deps, mkdocs-material, ruff, mkdocs-gen-files, and requests. Bumping Requests to 2.33 also resolves an open security warning. 

2.  DONE Add Card Usage Table in a Modal

    -   State "DONE"       from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-03-27 Fri 15:27]</span></span>
    
    Based on Preset Tags marked on Battle Reports. Accessible from the Cards Dashboard. Shows the 'runs used' and 'percentage used' (based on total runs recorded).
    
    -   Columns are sortable (higest, lowest, etc).
    -   Include a second table of Preset Usage
    -   May include Tournaments by default
    -   Place Button to access modal next to 'charts' button in upper right

3.  DONE Security Warning: Pygments has Regular Expression Denial of Service (ReDoS) due to Inefficient Regex for GUID Matching

    -   State "DONE"       from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-03-27 Fri 15:27]</span></span>
    
    A security flaw has been discovered in pygments up to 2.19.2. The impacted element is the function AdlLexer of the file pygments/lexers/archetype.py. The manipulation results in inefficient regular expression complexity. The attack is only possible with local access. The exploit has been released to the public and may be used for attacks. The project was informed of the problem early through an issue report but has not responded yet.
    
    Looks like there may not be a fix yet. But we should investigate the risks and if we can mitigate them within our codebase. 

4.  DONE Security Warning: Incomplete URL substring sanitization

    -   State "DONE"       from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-03-27 Fri 15:27]</span></span>
    
    Sanitizing untrusted URLs is a common technique for preventing attacks such as request forgeries and malicious redirections. Usually, this is done by checking that the host of a URL is in a set of allowed hosts.
    
        # core/management/commands/fetch_wiki_data.py:685 
        ...
        return parsed.netloc.endswith("fandom.com")
             ...
             #  The string fandom.com
             #   may be at an arbitrary position in the sanitized URL.
        
         def _fandom_page_title(url: str) -> str:

5.  DONE Bot Respec needs to Lock All Bots, reset levels and goals (for bots)     :bug:fix:

    -   State "DONE"       from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-03-27 Fri 15:27]</span></span>

6.  DONE Collapse Query Templates on Explore Dashboard     :fix:
...
### DONE Game v28.0 Changes <code>[5/5]</code>

-   State "DONE"       from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-04-11 Sat 15:24]</span></span>
-   State "TODO"       from "WAIT"       <span class="timestamp-wrapper"><span class="timestamp">[2026-04-09 Thu 14:36]</span></span>
-   State "WAIT"       from              <span class="timestamp-wrapper"><span class="timestamp">[2026-03-17 Tue 17:22] </span></span>   
    waiting on release notes

This will be a hardline update that will enforce the v28 patch boundary. New metrics and functionality will only work forward.

1.  DONE New Battle Report Metrics

    -   State "DONE"       from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-04-11 Sat 15:24]</span></span>
    -   Add all new metrics to Battle Report Derived Metrics at minimum or to appropriate models.
    -   Add Records metrics to Lifetime Stats modal
    
    This is what the new battle history looks like:
    Battle Report
    ...
    Utility
    Recovery Packages	4274
    Free Attack Upgrade	3761
    Free Defense Upgrade	3706
    Free Utility Upgrade	2198
    ...
    Orbs	467.17K
    Death Ray	0
    Chain Lightning	610.59K
    Smart Missiles	11.51K
    Inner Land Mines	0
    Poison Swamp	128.50K
    Death Wave	81.47K
    Black Hole	284.72K
    Chrono Field	0
    Land Mines	379.85K
    ...
    Fetch Gems	28
    Medals	7
    Reroll Shards Earned	928
    Reroll Shards Fetched	48
    Cannon Shards	31
    Armor Shards	45
    Generator Shards	40
    Core Shards	35
...
2.  DONE Verify parser can handle the new Battle Report format

    -   State "DONE"       from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-04-11 Sat 15:24]</span></span>

3.  DONE Charts are ignoring Blackhole Damage     :bug:

    -   State "DONE"       from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-04-11 Sat 15:24]</span></span>
    
    Chart shows 0% from Blackhole but battle report shows 'Black Hole Damage	16.46s' from run '4/3/2026, 9:07:00 AM • Run 296'
    
    Possibly due to magnitude of damage confusing the parser? 

4.  DONE Upgrade django version to 5.2.13

    -   State "DONE"       from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-04-11 Sat 15:24]</span></span>
    
    Will resolve some security warnings from Dependabot

5.  DONE Pull and merge Dependabot version bumps

    -   State "DONE"       from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-04-11 Sat 15:24]</span></span>
    
    Ruff, mypy, pymdown-extensions


<a id="orgb5501b8"></a>

### DONE Add a way to tag runs as dissonance

-   State "DONE"       from "IN PROGRESS" <span class="timestamp-wrapper"><span class="timestamp">[2026-04-18 Sat 19:32]</span></span>
-   State "IN PROGRESS" from "TODO"       <span class="timestamp-wrapper"><span class="timestamp">[2026-04-17 Fri 16:47]</span></span>

Will need to function similar to Tournament Runs. Shows in Battle History but filtered out in Charts/Explore.

Dissonance runs are special challenge runs added in Game version28. They add additional multipliers to a tier. Additional details can be found here, <https://the-tower-idle-tower-defense.fandom.com/wiki/Dissonance#Dissonant_Boost>.

We will need to separate Dissonance Runs from Regular runs.

The multipliers should be shown in a modal table on Battle History for each Tier logged.

The multiplier can be calculated with the following formula:

> \` 1 + (multiplier -1)\*(wave/5000)<sup>1.75</sup> \`

And validated with the following table:
...
<thead>
<tr>
<th scope="col" class="org-right">Wave</th>
<th scope="col" class="org-right">3x</th>
<th scope="col" class="org-right">5x</th>
</tr>
</thead>
...
<td class="org-right">1.239</td>
</tr>


<tr>
<td class="org-right">2000</td>
<td class="org-right">1.402</td>
<td class="org-right">1.805</td>
</tr>


<tr>
<td class="org-right">3000</td>
<td class="org-right">1.818</td>
<td class="org-right">2.636</td>
</tr>
...
Dissonance Coin Bonus is added to All Coin Bonus. Since it is not logged separately in Battle Reports there's no way to single out performance gains. Attack, Defense and Ultimate Weapon Damage are also not singled out in any meaningful way.

There is also additional Echo Labs that increase the multipliers, but that is outside of the scope of this tool for now. 
...
1.  TODO On Card Usage Modal Observed Metric needs to show the sum of the metric

2.  TODO Add Waves Skipped to 'Wave Skip' Card's Observed Metrics

3.  TODO Auto-migration of stored queries

    The Explore DSL is expected to evolve as metrics, aliases, and scopes change. When we introduce automatic migration for stored queries, it should focus on safe, deterministic transforms that preserve the user's intent without silently changing results.
    
    \### Scope
    
    -   Add a stored query schema version and preserve the original text alongside migrated output.
    -   Migrate only well-defined changes (for example, metric renames, alias consolidation, scope key renames, or output defaults) backed by registry metadata.
    ...
    -   Fail closed: if a migration cannot be applied, keep the original text and return a validation error with remediation guidance.
    -   Record migration metadata (version, timestamp, rule ids) for audit trails.
    -   Prefer additive behavior; removing unsupported tokens should be a last resort and must be explicitly flagged.
    -   Treat deprecated tokens as warnings with suggested replacements until a migration rule exists.
    -   Ensure the Explore registry exposes migration hints (aliases, deprecations, replacements) in one canonical location.


<a id="orgeaebe5e"></a>

## Backlog <code>[3/6]</code>
