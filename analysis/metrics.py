...
METRICS: Final[dict[str, MetricDefinition]] = {
    ...
    "game_reported_cells_per_hour": MetricDefinition(
    ...
    "game_reported_coins_per_hour": MetricDefinition(
    ...
    "coins_from_critical_coin": MetricDefinition(
    ...
    "coins_from_golden_combo": MetricDefinition(
        key="coins_from_golden_combo",
        label="Coins From Golden Combo",
        unit="coins",
        category=MetricCategory.economy,
        kind="observed",
    ),
    ...
    "record_highest_coins_per_minute": MetricDefinition(
    ...
    "record_largest_wave_skip": MetricDefinition(
    ...
    "record_most_coins_from_wave_skip": MetricDefinition(
        key="record_most_coins_from_wave_skip",
        label="Record: Most Coins From Wave Skip",
        unit="coins",
        category=MetricCategory.utility,
        kind="observed",
    ),
    "record_most_cells_from_wave_skip": MetricDefinition(
        key="record_most_cells_from_wave_skip",
        label="Record: Most Cells From Wave Skip",
        unit="cells",
        category=MetricCategory.utility,
        kind="observed",
    ),
    "record_largest_smart_missile_stack": MetricDefinition(
        key="record_largest_smart_missile_stack",
        label="Record: Largest Smart Missile Stack",
        unit="count",
        category=MetricCategory.utility,
        kind="observed",
    ),
    "record_largest_golden_combo": MetricDefinition(
        key="record_largest_golden_combo",
        label="Record: Largest Golden Combo",
        unit="count",
        category=MetricCategory.combat,
        kind="observed",
    ),
    "record_most_coins_from_golden_combo": MetricDefinition(
        key="record_most_coins_from_golden_combo",
        label="Record: Most Coins From Golden Combo",
        unit="coins",
        category=MetricCategory.combat,
        kind="observed",
    ),
    "record_largest_inner_landmine_charge": MetricDefinition(
        key="record_largest_inner_landmine_charge",
        label="Record: Largest Inner Landmine Charge",
        unit="count",
        category=MetricCategory.combat,
        kind="observed",
    ),
    ...
    "tower_damage_taken": MetricDefinition(
    ...
    "wall_damage_taken": MetricDefinition(
    ...
    "lifesteal_healing": MetricDefinition(
    ...
    "defense_percent_blocked_damage": MetricDefinition(
    ...
    "defense_absolute_blocked_damage": MetricDefinition(
    ...
    "chrono_field_blocked_damage": MetricDefinition(
    ...
    "chain_thunder_blocked_damage": MetricDefinition(
    ...
    "flame_bot_blocked_damage": MetricDefinition(
    ...
    "primordial_collapse_blocked_damage": MetricDefinition(
    ...
    "negative_mass_projector_blocked_damage": MetricDefinition(
    ...
    "enemies_destroyed_by_projectiles": MetricDefinition(
    ...
    "enemies_destroyed_by_chain_lightning": MetricDefinition(
    ...
    "enemies_destroyed_by_smart_missiles": MetricDefinition(
    ...
    "enemies_destroyed_by_inner_land_mines": MetricDefinition(
    ...
    "enemies_destroyed_by_poison_swamp": MetricDefinition(
    ...
    "enemies_destroyed_by_black_hole": MetricDefinition(
    ...
    "enemies_destroyed_by_flame_bot": MetricDefinition(
    ...
    "enemies_destroyed_by_other": MetricDefinition(
    ...
    "ad_gems_earned": MetricDefinition(
        key="ad_gems_earned",
    ...
    "medals_earned": MetricDefinition(
        key="medals_earned",
        label="Medals Earned",
        unit="count",
        category=MetricCategory.fetch,
    ...
    "enemy_attack_levels_skipped": MetricDefinition(
    ...
    "enemy_health_levels_skipped": MetricDefinition(
    ...
    "projectiles_count": MetricDefinition(
    ...
    "land_mines_spawned": MetricDefinition(
    ...
    "death_defy_count": MetricDefinition(
    ...
    "energy_shield_hits_absorbed": MetricDefinition(
    ...
    "second_wind_uses": MetricDefinition(
    ...
    "demon_mode_uses": MetricDefinition(
        key="demon_mode_uses",
