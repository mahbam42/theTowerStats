...
DEFAULT_REGISTRY: Final[MetricSeriesRegistry] = MetricSeriesRegistry(
    specs=(
        ...
        MetricSeriesSpec(
            ...
            description="Most coins gained from a single wave-skip event in the run.",
            unit="coins",
            category=MetricCategory.utility,
            kind="observed",
            source_model="BattleReport",
            aggregation="avg",
            time_index="timestamp",
            value_field="record_most_coins_from_wave_skip",
            allowed_transforms=frozenset({"none", "moving_average"}),
            supported_filters=_COMMON_FILTERS,
        ),
        MetricSeriesSpec(
            ...
            description="Most cells gained from a single wave-skip event in the run.",
            unit="cells",
            category=MetricCategory.utility,
            kind="observed",
            source_model="BattleReport",
            aggregation="avg",
            time_index="timestamp",
            value_field="record_most_cells_from_wave_skip",
            allowed_transforms=frozenset({"none", "moving_average"}),
            supported_filters=_COMMON_FILTERS,
        ),
        MetricSeriesSpec(
            ...
            description="Largest Smart Missile stack recorded by the game for the run.",
            unit="count",
            category=MetricCategory.utility,
            kind="observed",
            source_model="BattleReport",
            aggregation="avg",
            time_index="timestamp",
            value_field="record_largest_smart_missile_stack",
            allowed_transforms=frozenset({"none", "moving_average"}),
            supported_filters=_COMMON_FILTERS,
        ),
        MetricSeriesSpec(
            ...
            description="Largest Golden Combo recorded by the game for the run.",
            unit="count",
            ...
            aggregation="avg",
            time_index="timestamp",
            value_field="record_largest_golden_combo",
            allowed_transforms=frozenset({"none", "moving_average"}),
            supported_filters=_COMMON_FILTERS,
        ),
        MetricSeriesSpec(
            ...
            description="Most coins gained from a Golden Combo event in the run.",
            unit="coins",
            category=MetricCategory.combat,
            kind="observed",
            source_model="BattleReport",
            aggregation="avg",
            time_index="timestamp",
            value_field="record_most_coins_from_golden_combo",
            allowed_transforms=frozenset({"none", "moving_average"}),
            supported_filters=_COMMON_FILTERS,
        ),
        MetricSeriesSpec(
            ...
            description="Largest Inner Landmine charge recorded by the game for the run.",
            unit="count",
            category=MetricCategory.combat,
            kind="observed",
            source_model="BattleReport",
            aggregation="avg",
            time_index="timestamp",
            value_field="record_largest_inner_landmine_charge",
            allowed_transforms=frozenset({"none", "moving_average"}),
            supported_filters=_COMMON_FILTERS,
        ),
        MetricSeriesSpec(
        ...
        MetricSeriesSpec(
            ...
            description="Battle Report coins breakdown: coins earned from Golden Combo.",
            unit="coins",
            category=MetricCategory.economy,
            kind="observed",
            source_model="BattleReport",
            aggregation="sum",
            time_index="timestamp",
            value_field="coins_from_golden_combo",
            allowed_transforms=frozenset({"none", "cumulative", "moving_average"}),
            supported_filters=_COMMON_FILTERS,
        ),
        MetricSeriesSpec(
